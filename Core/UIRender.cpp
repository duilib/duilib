                              ...
                              BYTE uFade, bool hole, bool xtiled, bool ytiled)
{
    ...
    else
    {
                ...
                && rcCorners.left == 0 && rcCorners.right == 0 && rcCorners.top == 0 && rcCorners.bottom == 0)
        {
            ...
            {
                ::BitBlt(hDC,       // 目标DC
                         rcTemp.left, rcTemp.top,    // 目标x，y
                         rcTemp.right - rcTemp.left, rcTemp.bottom - rcTemp.top,     // 目标Wdith，Height
                         hCloneDC,   // 源DC
                         rcBmpPart.left + rcTemp.left - rc.left, rcBmpPart.top + rcTemp.top - rc.top,        // 源x，y
                         SRCCOPY);
            }
        }
        else

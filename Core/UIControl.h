...
public:
    ...
    virtual CWindowUI* GetManager() const;
    virtual void SetManager(CWindowUI* pManager, CControlUI* pParent, bool bInit = true);
    virtual CControlUI* GetParent() const;

	virtual bool SendEvent(UIEVENT dwType);
	virtual bool SendEvent(TEventUI *pEventUI);
	...
	virtual void SetPos(int x, int y, bool bNeedInvalidate = true);
